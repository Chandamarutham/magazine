...
Supports GET, OPTIONS, POST, PUT, DELETE methods.
"""
...
table = dynamodb.Table("advertiser_tbl")
# timestamp, email (primary key), company_name (index), contact_person_name (index),
# phone, website (nullable), business_type, advert_type, ad_place_preference,
# budget, reference (nullable)
all_fields: list = [
    "email",
    "company_name",
    "contact_person_name",
